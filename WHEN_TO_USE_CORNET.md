...
- **Rich, split out of the component:** DuDrawer, DuFab, DuRating, DuPagination, DuCountdown (own composables); DuSelect and DuSearch (facades over the shared combobox engine in `components/core/combobox/`) — 7 total.
