    ...
    <div class="bg-primary text-primary-content py-16">
      <div class="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div class="flex flex-wrap gap-3">
          ...
          <DuButton variant="neutral" size="lg" customClass="bg-primary-content text-primary border-0 hover:bg-primary-content/90" as="a" href="https://github.com/t-lecoublet/Cornet" target="_blank">
