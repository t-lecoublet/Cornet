...
const { preference, repoUrl } = useRepoPreference()
    ...
    <DuNavbar class="sticky top-0 z-50 shadow-none! bg-base-100/80 backdrop-blur border-b-2 border-base-300 shrink-0">
      ...
      <template #end>
        <div class="flex items-center gap-2 px-2">
          <DuButton variant="neutral" size="sm" outline as="a" href="https://gitlab.limos.fr/hub-isima/daisyui-vue-kit" target="_blank" :class="preference === 'gitlab' ? 'border-warning/60 text-warning' : ''">
          ...
          <DuButton variant="neutral" size="sm" outline as="a" href="https://github.com/t-lecoublet/Cornet" target="_blank" :class="preference === 'github' ? 'border-primary/60 text-primary' : ''">
